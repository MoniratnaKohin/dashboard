import { useBetData } from "../hooks/useBetData";
 ...
 export const PlatformOverview = () => {
 	...
 	const stats = [
 		{
 			label: "Platform TVL",
 			value: Number(tvlData) / 10 ** 6,
 			displayValue: `${formatOrParseNumber(Number(tvlData) / 10 ** 6)} USDT`,
 		...
 		{
 			label: "Liquidity Donated",
 			value: Number(tableData?.data?.liquidityDonated),
 			displayValue: `${Number(tableData?.data?.liquidityDonated)} USDT`,
 			icon: <FiDollarSign className="text-[#82FF1F] text-2xl" />,
 		},
 	];
